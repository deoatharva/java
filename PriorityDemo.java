...
class PriorityDemo
{
	...
	{
		ChildThread obj1=new ChildThread("First",Thread.NORM_PRIORITY-2);
		ChildThread obj2=new ChildThread("Second",Thread.NORM_PRIORITY+2);
		ChildThread obj3=new ChildThread("Third",Thread.NORM_PRIORITY+3);
